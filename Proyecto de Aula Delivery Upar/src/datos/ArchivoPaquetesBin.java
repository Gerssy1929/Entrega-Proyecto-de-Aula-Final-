 ...
 * @author German
 */
public class ArchivoPaquetesBin implements IArchivoRegistroPaquete {
    private File archivo;
    private FileInputStream aLectura;
    private FileOutputStream aEscritura;

    public ArchivoPaquetesBin() {
        this.archivo = new File("Paqueteria.dat");
    }
    
    
    private void guardarList(ListPaquetes lista) throws IOException{
    ...
    public Paquete eliminar(String id) throws IOException {
        ListPaquetes lista = this.leerLista();
        Paquete eliminado = lista.eliminar(id);
